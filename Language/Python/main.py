...
def add_to_dict(dic={},key=str,value=str):
    if type(dic) != dict:
...
def update_word(dic={},key=str,value=str):
    if type(dic) != dict:
        print(f"You need to send a dictionary. You sent: {type(dic)}")
    elif type(value) != str:
...
def delete_from_dict(dic={},key=str):
    if type(dic) != dict:
        print(f"You need to send a dictionary. You sent: {type(dic)}")
    elif type(key) != str:
        print("You need to specify a word to delete.")
    elif key not in dic:
        print(f"{key} is not on this dict. Won't delete.")
    else:
        del(dic[key])
